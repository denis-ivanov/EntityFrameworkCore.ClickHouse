...
public static class ClickHouseFloat64DbFunctionsExtensions
{
    ...
    extension(DbFunctions _)
    {
        ...
        public double ToFloat64<TNumber>(TNumber expr) where TNumber : INumber<TNumber>
        {
        ...
        /// </exception>
        /// <remarks>https://clickhouse.com/docs/sql-reference/functions/type-conversion-functions#toFloat64</remarks>
        public double ToFloat64(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        public double ToFloat64OrZero(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        public double? ToFloat64OrNull(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        public double ToFloat64OrDefault(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        /// </exception>
        /// <remarks>https://clickhouse.com/docs/sql-reference/functions/type-conversion-functions#toFloat64OrDefault</remarks>
        public double ToFloat64OrDefault(string expr, double defaultValue)
        {
            throw new InvalidOperationException();
        }
    }
