    ...
    : ValueConvertersEndToEndTestBase<ValueConvertersEndToEndClickHouseTest.ValueConvertersEndToEndClickHouseFixture>
{
    ...
    [InlineData(nameof(ConvertingEntity.StringToTimeSpan), "Time64(9)", false)]
    [InlineData(nameof(ConvertingEntity.StringToNullableTimeSpan), "Time64(9)", false)]
    ...
    [InlineData(nameof(ConvertingEntity.NullableStringToTimeSpan), "Time64(9)", true)]
    [InlineData(nameof(ConvertingEntity.NullableStringToNullableTimeSpan), "Time64(9)", true)]
