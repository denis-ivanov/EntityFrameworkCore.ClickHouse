...
public static class ClickHouseDecimal128DbFunctionsExtensions
{
    ...
    extension(DbFunctions _)
    {
        ...
        /// <returns></returns>
        public decimal ToDecimal128(string number, [Range(0, 38)] byte scale)
        {
        ...
        /// <param name="scale">Scale parameter between 0 and 38, specifying how many digits the fractional part of a number can have.</param>
        /// <returns></returns>
        public decimal ToDecimal128<TNumber>(TNumber number, [Range(0, 38)] byte scale) where TNumber : INumber<TNumber>
        {
            throw new InvalidOperationException();
        }
        ...
        /// <param name="scale">Scale parameter between 0 and 38, specifying how many digits the fractional part of a number can have.</param>
        /// <returns></returns>
        public decimal ToDecimal128OrZero(string number, [Range(0, 38)] byte scale)
        {
            throw new InvalidOperationException();
        }
        ...
        public decimal? ToDecimal128OrNull(string number, [Range(0, 38)] byte scale)
        {
            throw new InvalidOperationException();
        }
        ...
        /// <param name="scale">Scale parameter between 0 and 38, specifying how many digits the fractional part of a number can have.</param>
        /// <returns></returns>
        public decimal ToDecimal128OrDefault(string number, [Range(0, 38)] byte scale)
        {
            throw new InvalidOperationException();
        }
        ...
        /// <returns></returns>
        public decimal ToDecimal128OrDefault(string number, [Range(0, 38)] byte scale, decimal defaultValue)
        {
            throw new InvalidOperationException();
        }
    }
