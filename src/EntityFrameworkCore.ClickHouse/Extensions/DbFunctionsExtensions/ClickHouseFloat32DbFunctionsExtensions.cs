...
public static class ClickHouseFloat32DbFunctionsExtensions
{
    ...
    extension(DbFunctions _)
    {
        ...
        public float ToFloat32<TNumber>(TNumber expr) where TNumber : INumber<TNumber>
        {
        ...
        /// </exception>
        /// <remarks>https://clickhouse.com/docs/sql-reference/functions/type-conversion-functions#tofloat32</remarks>
        public float ToFloat32(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        public float ToFloat32OrZero(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        public float? ToFloat32OrNull(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        public float ToFloat32OrDefault(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        /// </exception>
        /// <remarks>https://clickhouse.com/docs/sql-reference/functions/type-conversion-functions#tofloat32ordefault</remarks>
        public float ToFloat32OrDefault(string expr, float defaultValue)
        {
            throw new InvalidOperationException();
        }
    }
