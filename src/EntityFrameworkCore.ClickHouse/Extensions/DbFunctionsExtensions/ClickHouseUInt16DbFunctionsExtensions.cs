...
public static class ClickHouseUInt16DbFunctionsExtensions
{
    ...
    extension(DbFunctions _)
    {
        ...
        public ushort ToUInt16<TNumber>(TNumber expr) where TNumber : INumber<TNumber>
        {
        ...
        /// <returns></returns>
        /// <remarks>https://clickhouse.com/docs/sql-reference/functions/type-conversion-functions#toUInt16</remarks>
        public ushort ToUInt16(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        /// <returns></returns>
        public ushort ToUInt16OrZero(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        /// <param name="expr">A String representation of a number.</param>
        /// <returns></returns>
        public ushort? ToUInt16OrNull(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        public ushort ToUInt16OrDefault(string expr)
        {
            throw new InvalidOperationException();
        }
        ...
        /// <returns></returns>
        /// <remarks>https://clickhouse.com/docs/sql-reference/functions/type-conversion-functions#toUInt16ordefault</remarks>
        public ushort ToUInt16OrDefault(string expr, ushort defaultValue)
        {
            throw new InvalidOperationException();
        }
    }
