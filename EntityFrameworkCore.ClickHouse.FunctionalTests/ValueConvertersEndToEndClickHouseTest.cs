    ...
    : ValueConvertersEndToEndTestBase<ValueConvertersEndToEndClickHouseTest.ValueConvertersEndToEndClickHouseFixture>
{
    ...
    [InlineData(nameof(ConvertingEntity.StringToBool), "UInt8", false)]
    [InlineData(nameof(ConvertingEntity.StringToNullableBool), "UInt8", false)]
    ...
    [InlineData(nameof(ConvertingEntity.StringToChar), "FixedString(1)", false)]
    [InlineData(nameof(ConvertingEntity.StringToNullableChar), "FixedString(1)", false)]
    ...
    [InlineData(nameof(ConvertingEntity.StringToTimeSpan), "String", false)]
    [InlineData(nameof(ConvertingEntity.StringToNullableTimeSpan), "String", false)]
    ...
    [InlineData(nameof(ConvertingEntity.NullableBoolAsChar), "FixedString(1)", true)]
    [InlineData(nameof(ConvertingEntity.NullableBoolAsNullableChar), "FixedString(1)", true)]
    ...
    [InlineData(nameof(ConvertingEntity.NullableStringToBool), "UInt8", true)]
    [InlineData(nameof(ConvertingEntity.NullableStringToNullableBool), "UInt8", true)]
    ...
    [InlineData(nameof(ConvertingEntity.NullableStringToChar), "FixedString(1)", true)]
    [InlineData(nameof(ConvertingEntity.NullableStringToNullableChar), "FixedString(1)", true)]
    ...
    [InlineData(nameof(ConvertingEntity.NullableStringToTimeSpan), "String", true)]
    [InlineData(nameof(ConvertingEntity.NullableStringToNullableTimeSpan), "String", true)]
